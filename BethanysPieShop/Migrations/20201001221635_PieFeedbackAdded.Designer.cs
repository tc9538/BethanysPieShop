...
namespace BethanysPieShop.Migrations
{
    ...
    [Migration("20201001221635_PieFeedbackAdded")]
    partial class PieFeedbackAdded
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("BethanysPieShop.Models.PieFeedback", b =>
                {
                    b.Property<int>("PieId")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("BethanysPieShop.Models.PieFeedback", b =>
                {
                    b.HasOne("BethanysPieShop.Models.Pie", null)
                        .WithOne("PieFeedback")
                        .HasForeignKey("BethanysPieShop.Models.PieFeedback", "PieId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
                });
